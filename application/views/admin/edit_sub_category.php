    ...
    <div class="col-md-12">                        
        <div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="panel-body">
                ...
                <form role="form" action="<?php echo base_url() ?>super_admin/update_sub_category" method="post" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="field-1" name="sub_category_name" value="<?php echo $sub_category_info->sub_category_name; ?>">
                            <input type="hidden" name="sub_category_id" value="<?php echo $sub_category_info->sub_category_id; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="radio ">
                                <?php
                                    if($sub_category_info->publication_status==0)
                                    {
                                ?>
